...
![Metrics unit type selection](/images/metrics/unit-type-selection.png)
...
![Events tab view](/images/metrics/events-tab-view.png)

You can toggle between a list view or chart view of your events to view the trend line over time.  

![Events chart view](/images/metrics/events-chart-view.png)
...
![Event detailed view](/images/metrics/event-detailed-view.png)
...
![Metrics catalog](/images/metrics/metrics-catalog.png)
 ...
 ![Metrics chart view](/images/metrics/metrics-chart-view.png)
