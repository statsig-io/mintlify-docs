...
![Archive Grace Period](/images/metrics/archive-grace-period.png)
...
![Archive after grace period](/images/metrics/archive-after-grace-period.png)
...
![State graph](/images/metrics/auto-archival-state-graph.png)
...
![Metric References](/images/metrics/metric-references.png)
...
![Banner](/images/metrics/archival-banner.png)
...
![Dropdown](/images/metrics/mark-permanent-dropdown.png)

If you’d like to turn off auto-archiving entirely for your project, you may do so in the Project Settings page

![Project Settings](/images/metrics/auto-archiving-project-settings.png)
...
![Delete metric](/images/metrics/delete-metric-menu.png)
...
![Dependencies](/images/metrics/delete-dependencies.png)
...
![Undo delete](/images/metrics/undo-delete.png)
