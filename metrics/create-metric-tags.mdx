...
![Metrics catalog navigation](/images/metrics/metrics-catalog-navigation.png)
...
![Tags filter management](/images/metrics/tags-filter-management.png)
...
![Create new tag dialog](/images/metrics/create-new-tag-dialog.png)
...
![Metrics catalog with tag management interface](/images/metrics/metrics-catalog-tag-interface.png)
...
![Pulse results showing tagged metric lifts](/images/metrics/pulse-tagged-metric-lifts.png)
...
![Core metrics filter view](/images/metrics/core-metrics-filter-view.png)
