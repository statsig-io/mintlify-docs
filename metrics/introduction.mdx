...
![Data integration architecture diagram](/images/metrics/data-integration-architecture.png)
...
![Product observability dashboard overview](/images/metrics/product-observability-dashboard.png)
