...
7. Optional: Gradual Migration Using Adapter {props.migrationAdapterLink ? "" : "(Not supported yet)"}
...
{props.migrationAdapterLink && <div>- [{props.migrationAdapterLink}]({props.migrationAdapterLink})</div>}
