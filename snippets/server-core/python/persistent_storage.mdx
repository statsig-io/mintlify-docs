...
Persistent storage allows you to persist user assignments across sessions. This is useful for maintaining consistent user experiences in experiments and feature rollouts.
