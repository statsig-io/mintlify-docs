...
Local overrides are useful for testing and development. They allow you to override the values of gates, configs, experiments, and layers without changing the values in the Statsig console.
