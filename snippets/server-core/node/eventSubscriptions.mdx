...
The Node Core SDK provides an event subscription system that allows you to listen for evaluation events. This can be useful for logging, debugging, or integrating with other systems.
