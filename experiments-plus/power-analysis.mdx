...
![Power Analysis entry points](/images/experiments/power-analysis/navigation.png)
...
![Power analysis form inputs](/images/experiments/power-analysis/form-inputs.png)

Your past power analysis calculations will be available to view in the "Past Analyses" tab.

![Past power analyses list](/images/experiments/power-analysis/past-analyses.png)
...
![Power analysis attachment interface](/images/experiments/attach-power-analysis-to-experiment.png)
...
![Fixed allocation analysis results chart](/images/experiments/power-analysis/fixed-allocation.png)
...
![Fixed MDE analysis results table](/images/experiments/power-analysis/fixed-mde.png)

## Advanced Options

![Advanced power analysis options interface](/images/experiments/power-analysis/advanced-options.png)
...
![MDE calculation formula](/images/experiments/power-analysis/mde-formula.png)
