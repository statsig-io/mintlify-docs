...
<Frame>
  <img src="/images/web_analytics/web-analytics-dash-1.png" alt="Statsig metrics events dashboard displaying comprehensive web analytics data including visitor counts, page views, and user interactions" />
</Frame>
...
<Frame>
  <img src="/images/web_analytics/autocap-key.png" alt="Statsig project settings interface showing client API key configuration and environment setup options" />
</Frame>
...
<Frame>
  <img src="/images/web_analytics/autocapture-settings.png" alt="Statsig analytics event filtering configuration interface allowing users to disable specific autocapture events from the console" />
</Frame>
