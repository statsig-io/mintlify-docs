...
With Statsig, you can run thousands of A/B tests, safely rollout features, and dive deep on core business metrics and user behavior—all on a single, unified platform.

<Columns cols={3}>
  <Card 
    title="SDK Quickstart" 
    icon="/images/staticons/flash.svg"
  ...
  <Card 
    ...
    icon="/images/staticons/data.svg"
  ...
  <Card 
    ...
    icon="/images/staticons/users.svg"
...
<Columns cols={3}>
  <Card 
    title="Feature Flags" 
    icon="/images/staticons/flag.svg"
  ...
  <Card 
    ...
    icon="/images/staticons/experiment.svg"
  ...
  <Card 
    ...
    icon="/images/staticons/metrics-explorer.svg"
