...
- **C++** - Native desktop applications
- **.NET** - Windows and cross-platform applications

### Server SDKs
- **Node.js** - JavaScript runtime for servers
- **Python** - Python web applications and services
- **Go** - High-performance server applications
- **Java** - Enterprise server applications
- **Ruby** - Ruby on Rails and other Ruby frameworks
- **PHP** - PHP web applications
- **C#/.NET** - ASP.NET and .NET Core applications
- **Rust** - High-performance system applications
- **Elixir** - Concurrent, fault-tolerant applications
