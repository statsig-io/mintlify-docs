...
- **[Python](/server-core/python-core)**: Stable, [PyPI](https://pypi.org/project/statsig-python-core/)
- **[Java](/server-core/java-core)**: Stable, [Maven Central](https://central.sonatype.com/artifact/com.statsig/javacore/overview)
