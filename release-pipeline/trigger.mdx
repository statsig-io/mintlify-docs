...
<Frame>
  <img src="/img/release-pipeline/modal-attach.png" alt="Attaching a pipeline during creation" />
</Frame>
...
<Frame>
  <img src="/img/release-pipeline/sidebar-attach.png" alt="Attaching a pipeline via sidebar" />
</Frame>
...
<Frame>
  <img src="/img/release-pipeline/trigger.png" alt="Confirmation dialog when triggering a pipeline" />
</Frame>
...
<Frame>
  <img src="/img/release-pipeline/view-status.png" alt="Status banner showing release progress" />
</Frame>
