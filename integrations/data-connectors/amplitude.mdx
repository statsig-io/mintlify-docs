...
2. Go to Amplitude and navigate to the Data Destinations page. Click the
   ...
   ![](https://console.statsig.com/images/integrations/amplitude:incoming_integration_steps/step_1.png)

3. From the Destinations Catalog, search for and select the Statsig Event
   Streaming destination.

   ![](https://console.statsig.com/images/integrations/amplitude:incoming_integration_steps/step_2.png)

4. Give this destination a name and click "Create Sync".

   ![](https://console.statsig.com/images/integrations/amplitude:incoming_integration_steps/step_3.png)
...
5. Enter the "Server Secret Key" you copied in Step 1 into the provided
   ...
   ![](https://console.statsig.com/images/integrations/amplitude:incoming_integration_steps/step_4.png)
...
1. Navigate to Amplitude and click on the Settings button in the
   ...
   ![](https://console.statsig.com/images/integrations/amplitude_integration_steps/settings.png)

2. Click on the Projects tab and choose the Project you wish to send data
   to.

   ![](https://console.statsig.com/images/integrations/amplitude_integration_steps/project.png)

3. Copy the API Key and paste it in the Statsig integration panel.

   ![](https://console.statsig.com/images/integrations/amplitude_integration_steps/api_key.png)
...
4. Hit Enable on the integration panel and any data logged to Statsig will show up in your
   ...
   ![](https://console.statsig.com/images/integrations/amplitude_integration_steps/amplitude_data.png)
