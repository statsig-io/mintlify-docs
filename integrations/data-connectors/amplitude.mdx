...
2. Go to Amplitude and navigate to the Data Destinations page. Click the
   ...
   <Frame>
     <img src="https://console.statsig.com/images/integrations/amplitude:incoming_integration_steps/step_1.png" alt="" />
   </Frame>
...
3. From the Destinations Catalog, search for and select the Statsig Event
   ...
   <Frame>
     <img src="https://console.statsig.com/images/integrations/amplitude:incoming_integration_steps/step_2.png" alt="" />
   </Frame>

4. Give this destination a name and click "Create Sync".

   <Frame>
     <img src="https://console.statsig.com/images/integrations/amplitude:incoming_integration_steps/step_3.png" alt="" />
   </Frame>
...
5. Enter the "Server Secret Key" you copied in Step 1 into the provided
   ...
   <Frame>
     <img src="https://console.statsig.com/images/integrations/amplitude:incoming_integration_steps/step_4.png" alt="" />
   </Frame>
...
1. Navigate to Amplitude and click on the Settings button in the
   ...
   <Frame>
     <img src="https://console.statsig.com/images/integrations/amplitude_integration_steps/settings.png" alt="" />
   </Frame>
...
2. Click on the Projects tab and choose the Project you wish to send data
   ...
   <Frame>
     <img src="https://console.statsig.com/images/integrations/amplitude_integration_steps/project.png" alt="" />
   </Frame>

3. Copy the API Key and paste it in the Statsig integration panel.

   <Frame>
     <img src="https://console.statsig.com/images/integrations/amplitude_integration_steps/api_key.png" alt="" />
   </Frame>
...
4. Hit Enable on the integration panel and any data logged to Statsig will show up in your
   ...
   <Frame>
     <img src="https://console.statsig.com/images/integrations/amplitude_integration_steps/amplitude_data.png" alt="" />
   </Frame>
