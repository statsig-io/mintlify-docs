...
3. Toggle the segment type from **Conditional** to **ID List**.
   <Frame>
     <img src="https://github.com/user-attachments/assets/af7c5cb3-adc2-4e88-a411-b5844a541e49" alt="Create New Segment" />
   </Frame>
4. Select the **ID type** you want to build from.
   <Frame>
     <img src="https://github.com/user-attachments/assets/958b7545-7f23-4559-8a66-99af01d39952" alt="Create New Segment" />
   </Frame>
...
<Frame>
  <img src="https://github.com/user-attachments/assets/ee94e6bc-475b-47a0-96a7-5ddba398d58c" alt="Create New Segment" />
</Frame>
