...
To get started with Log Explorer, follow the [OTEL onboarding guide](/server/concepts/open_telemetry) to set up log ingestion. Once that's ready, you can navigate from **Infra Analytics → Log Explorer** from the Statsig left menu.
