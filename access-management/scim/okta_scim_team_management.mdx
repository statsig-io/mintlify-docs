...
![img](/images/okta_scim_steps/team_steps/step1-create-team.png)
...
![img](/images/okta_scim_steps/team_steps/step2-verify-import.png)
...
![img](/images/okta_scim_steps/team_steps/step3-create-mapping-group.png)
...
1. In Okta, go to the Statsig Integration's "Push Teams" tab and select "Push Groups". Then pick the mapping group created in the previous step.
   ![img](/images/okta_scim_steps/team_steps/step4-push-teams-1.png)
...
![img](/images/okta_scim_steps/team_steps/step4-push-teams-2.png)
...
![img](/images/okta_scim_steps/team_steps/step5-verify-push.png)
...
![img](/images/okta_scim_steps/team_steps/step6-delete-1.png)
...
![img](/images/okta_scim_steps/team_steps/step6-delete-2.png)
...
![img](/images/okta_scim_steps/team_steps/step7-create-1.png)
...
![img](/images/okta_scim_steps/team_steps/step7-create-2.png)
