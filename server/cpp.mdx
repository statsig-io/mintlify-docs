---
title: Legacy C++ Server SDK
sidebarTitle: Legacy C++
description: Statsig's Legacy Server SDK for C++ applications
icon: "c"
---
...
[Github Repository](https://github.com/statsig-io/cpp-server-sdk)
