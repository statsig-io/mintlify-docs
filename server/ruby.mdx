---
title: Legacy Ruby Server SDK
sidebarTitle: Legacy Ruby
description: Statsig's Legacy Server SDK for Ruby applications
icon: "gem"
---
...
[Github Repository](https://github.com/statsig-io/ruby-sdk)
