...
![Statsig logstream showing GTM events flowing in](/images/gtm-logstream.png)
_(statsig logstream showing gtm events flowing in)_

### Step 1: Create new tag 
![GTM create new tag interface for Statsig integration](/images/gtm-create-tag.png)

### Step 2: Choose tag type
Choose "Custom HTML" for tag type, and paste [this GTM code](#gtm-code) (including script tag)

![GTM tag configuration screen with custom HTML setup](/images/gtm-tag-configuration.png)

### Step 3: Adjust fire options
Under Advanced Settings under "Tag Firing options", select "Once per page"

![GTM tag firing options settings for once per page](/images/gtm-create-tag-options.png)

### Step 4: Set Tag Trigger
Below the "Tag Configuration" section, set the Trigger to "Initialization - All Pages" Option. 

![GTM tag trigger configuration for all pages initialization](/images/gtm-tag-trigger.png)
