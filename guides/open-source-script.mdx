...
![Example 1 - LaunchDarkly to Statsig translation](/images/tutorials/migration-launchdarkly/open-source/example-translation-1.png)

**Example 2:** LaunchDarkly flag with country-based targeting (off flag)

![Example 2 - LaunchDarkly to Statsig translation](/images/tutorials/migration-launchdarkly/open-source/example-translation-2.png)
