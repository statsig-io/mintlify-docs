...
![Sidecar A/A test experiment setup interface](/images/sidecar_aa_setup.png)
...
![Sidecar A/A test variant configuration screen](/images/sidecar_aa_select.png)

Repeating the step above, you'll do the exact same action for the variant 'Test'. Your set up should look like the following. 

![Sidecar A/A test final configuration showing identical variants](/images/sidecar_aa_final.png)
