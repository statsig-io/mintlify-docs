...
![Feature gate rules with raw user IDs](/images/id_resolver1.png)
...
![Feature gate rules with resolved ID names](/images/id_resolver2.png)
...
![ID autocomplete functionality in action](/images/id_resolver3.png)
...
![ID resolver usage across console interfaces](/images/id_resolver_4.png)
...
![ID resolver integration setup screen](/images/id_resolver_setup_1.png)

![ID resolver webhook configuration interface](/images/id_resolver_setup_2.png)
