...
![Parameter Store Mapping](/images/tutorials/parameter-stores/param_stores_mapping.png)
...
![Parameter Store Experiment Mapping](/images/tutorials/parameter-stores/param_stores.gif)
