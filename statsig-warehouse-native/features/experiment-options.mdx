...
Configures multiple-comparisons corrections - either controlling the false positive rate or false discovery rate. Refer to the more detailed documentation for [Bonferroni]() and [Benjamini-Hochberg](/stats-engine/methodologies/benjamini–hochberg-procedure).
