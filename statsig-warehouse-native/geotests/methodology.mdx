...
<Frame>
  <img src="/images/geotests/GeosPreTest.png" alt="Example data from the GeoLift package walkthrough. " />
</Frame>
...
<Frame>
  <img src="/images/geotests/GeosTest.png" alt="A marketing campaign that starts on day 91 (black dotted line) could have affected the treatment cities of Chicago and Portland. But how can you tell any real effect from all the noise?" />
</Frame>
...
<Frame>
  <img src="/images/geotests/Period_Split.png" alt="Geotest period split diagram showing pre-treatment and post-treatment phases" />
</Frame>

<Frame>
  <img src="/images/geotests/Incremental_Effects.png" alt="Subtracting the modeled Synthetic Control values from the observed Treatment values reveals any incremental effect for the Treatment geos." />
</Frame>
