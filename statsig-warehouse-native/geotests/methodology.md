...
![Example data from the GeoLift package walkthrough. ](/images/geotests/GeosPreTest.png)
...
![A marketing campaign that starts on day 91 (black dotted line) could have affected the treatment cities of Chicago and Portland. But how can you tell any real effect from all the noise?](/images/geotests/GeosTest.png)
...
![Geotest period split diagram showing pre-treatment and post-treatment phases](/images/geotests/Period_Split.png)

![Subtracting the modeled Synthetic Control values from the observed Treatment values reveals any incremental effect for the Treatment geos.](/images/geotests/Incremental_Effects.png)
