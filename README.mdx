...
Mintlify packages their product with hosting, so we don't manage the docs infra anymore. If you have any issues, we can reach the Mintlify team via Slack.
