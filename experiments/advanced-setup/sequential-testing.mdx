...
![Sequential testing results visualization](/images/experiments/sequential-testing-example.png)
...
![Sequential testing configuration interface](/images/experiments/enable-freq-sequential-testing.png)
