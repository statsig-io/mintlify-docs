...
<Frame>
  <img src="/images/experiments/sprt/sprt_scorecard.png" alt="SPRT experiment results scorecard" />
</Frame>
...
<p align="center">
<img src="/images/experiments/sprt/sprt_hover_card.png" alt="SPRT Hover Card" width="500" align="center"/>
</p>
...
<Frame>
  <img src="/images/experiments/sprt/sprt_power_analysis.png" alt="SPRT power analysis configuration interface" />
</Frame>
...
<Frame>
  <img src="/images/experiments/sprt/sprt_results_readout.png" alt="SPRT experiment results dashboard" />
</Frame>
...
- $ N_{A}$ and $ N_{B}$ are the number of observed units for each group
...
- **Standard Deviation**: A baseline standard deviation for the metric, $ \sigma_{X}$
